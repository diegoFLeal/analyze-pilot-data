...
png(filename="~/Desktop/f2f_renn.png", heigh=4000, width=6000)
plot(network, 
...
png(filename="~/Desktop/onlineinteract_renn.png", heigh=4000, width=6000)
plot(network, 
     layout=layout.fruchterman.reingold, 
     main="fruchterman.reingold", 
     vertex.size = degree(network)*.1, 
...
png(filename="~/Desktop/sentiment_renn.png", heigh=4000, width=6000)
plot(network, 
     layout=layout.fruchterman.reingold, 
     main="fruchterman.reingold", 
     vertex.size = degree(network)*.1, 
